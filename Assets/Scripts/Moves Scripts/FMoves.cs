            ...
            case 'P':
                if (color == 'W')
                {
                    if (row < tRow - 1)
                    {
                        ...
                        {
                            if (row == 1 && board[row + 2, col] == "E" && world.boardLoader.extraBoard[row + 1, col] != 1)
                            {
                ...
                else if (color == 'B')
                {
                    if (row > 0)
                    {
                        ...
                        if (board[row - 1, col] == "E")
                        {
                            if (row == tRow - 2 && board[row - 2, col] == "E" && world.boardLoader.extraBoard[row - 1, col] != 1)
                            {
                                tempBoard[row - 2, col] = 1;
                            }
                            tempBoard[row - 1, col] = 1;
            ...
            case 'B':
                for (int i = 0; i < 4; i++)
                {
                    ...
                    while (currRow >= 0 && currRow < tRow && currCol >= 0 && currCol < tCol && board[currRow, currCol][0] != color && board[currRow, currCol] != "0")
                    {
                        ...
                        if (board[currRow, currCol][0] != 'E' || world.boardLoader.extraBoard[currRow, currCol] == 1)
                        {
                            break;
                        }
                        currRow += rowAdder;
