...
public class PortalMoves : Moves
{
        ...
        switch (toSwitch)
        {
            case 'P':
                if (color == 'W')
                {
                    if (row < tRow - 1)
                    {
                        ...
                        if(col == 0 && board[row + 1, tCol -1 ][0] == 'B')
                        {
                            tempBoard[row + 1, tCol - 1] = 1;
                        }
                        ...
                        if (col == tCol - 1 && board[row + 1, 0][0] == 'B')
                        {
                            tempBoard[row + 1, 0] = 1;
                        }
                ...
                else if (color == 'B')
                {
                    if (row > 0)
                    {
                        if (col == 0 && board[row - 1, tCol - 1][0] == 'W')
                        {
                            tempBoard[row - 1, tCol - 1] = 1;
                        }
                        // if the pawn is not on the left edge and the left spot either is empty or has a black piece
                        ...
                        // if the pawn is not on the right edge and the right spot is either empty or has a black piece
                        if (col == tCol - 1 && board[row - 1, 0][0] == 'W')
                        {
                            tempBoard[row - 1, 0] = 1;
                        }
            ...
            case 'N':
                ...
                for (int i = 0; i < 8; i++)
                {
                    ...
                    } else if(col + knightMoves[i,1] < 0)
                    {
                        if (row + knightMoves[i, 0] >= 0 && row + knightMoves[i, 0] < tRow && board[row + knightMoves[i, 0], col + knightMoves[i, 1] + tCol][0] != color && board[row + knightMoves[i, 0], col + knightMoves[i, 1] + tCol] != "0")
                        {
                            tempBoard[row + knightMoves[i, 0], col + knightMoves[i, 1] + tCol] = 1;
                        }
                    }
                    else if (col + knightMoves[i, 1] > tCol - 1)
                    {
                        if (row + knightMoves[i, 0] >= 0 && row + knightMoves[i, 0] < tRow && board[row + knightMoves[i, 0], col + knightMoves[i, 1] - tCol][0] != color && board[row + knightMoves[i, 0], col + knightMoves[i, 1] - tCol] != "0")
                        {
                            tempBoard[row + knightMoves[i, 0], col + knightMoves[i, 1] - tCol] = 1;
