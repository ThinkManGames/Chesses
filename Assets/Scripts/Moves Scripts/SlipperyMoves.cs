...
public class SlipperyMoves : Moves
{
        ...
        switch (toSwitch)
        {
            ...
            case 'B':
                for (int i = 0; i < 4; i++)
                {
                    ...
                    {
                        if(currRow + rowAdder >= tRow || currCol + colAdder >= tCol || currRow + rowAdder < 0 || currCol + colAdder < 0 || board[currRow, currCol][0] != 'E' || board[currRow + rowAdder, currCol + colAdder][0] == color)
                        {
